...
class User:
    ...
    def __init__(self, name: str = None, agencia: str = None, conta: str = None, current_balance: float = None,
    ...
    def validate_conta(conta: str) -> Tuple[bool, str]:
        ...
        if type(conta) is not str:
            return False, "A conta precisa ser uma string"
        else:
            if conta.find("-") != 5:
                return False, "Formato inválido, conta precisa de - no 5º digito"
            if len(conta) != 7:
                return False, "Formato inválido, conta precisa ter 7 digitos"
        return True, ""
    ...
    def validate_current_balance(current_balance: float) -> Tuple[bool, str]:
        ...
        if type(current_balance) is not float and current_balance != 0:
    ...
    def validate_admin_permission(admin_permission: bool) -> Tuple[bool, str]:
        ...
        if type(admin_permission) is not bool:
    ...
    def __repr__(self):
        return (f"User(name={self.name}, "
                ...
                f"admin_permission={self.admin_permission})")
